...
**Source:** Xue et al., “An Illusion of Progress? Assessing the Current State of Web Agents”, COLM 2025 (arXiv:2504.01382) for the baseline · Online-Mind2Web leaderboard, human evaluation, as of 4 August 2026, for the current figures · 300 tasks, 136 websites · [to the source](https://arxiv.org/abs/2504.01382) · [to the leaderboard](https://huggingface.co/spaces/osunlp/Online_Mind2Web_Leaderboard)
